...
uint256 hashGenesisBlock("0x87c62626db7564ab3c075dadc8b67b5830731f1fe458c0ab877251851bf3f7bb");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 2); // starting difficulty is 1 / 2^12
...
const string strMessageMagic = "420coin Signed Message:\n";
...
static const int64 nTargetTimespan = 600; // 420coin: 0.35 days
static const int64 nTargetSpacing = 60; // 420coin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal 420coin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "420coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 1396857047;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085502259;
